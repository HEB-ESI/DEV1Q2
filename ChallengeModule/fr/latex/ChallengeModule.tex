...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
                ...
                pdfauthor={}, pdftitle={Challenge : les modules}, pdfkeywords={Challenge : les modules, },pdfpagemode=UseOutlines,pdfpagetransition=Dissolve,nesting=true,
			...
			\footnotesize{1\`ere ann\'ee}}
				...
				%\maketitle
				\cadretitre{TD1}{Challenge : les modules}
				\thispagestyle{fancy}
        ...
        \end{sideways}}
            \begin{abstract}
			Avez-vous compris la d\'ecoupe en modules ? Voyons \c ca en relevant le d\'efi du "pas du z\'ebu" :
      ...
      \'Ecrivez un module qui re\c coit un nom en param\`etre et qui affiche le texte :
      ...
      \verb@pas = √ (poids / |1 − PI|)@
      \'Ecrivez un module qui re\c coit le poids du Z\'ebu en param\`etre et retourne la
      ...
      \'Ecrivez un module qui permette \`a  l'utilisateur de choisir laquelle de 4 approximations de PI utiliser.
      Votre module affichera les diff\'erentes valeurs de PI et l'utilisateur choisira celle qui lui convient.
      L'utilisateur fera ce choix en entrant le num\'ero d'ordre dans la liste affich\'ee des diff\'erentes valeurs de PI.
    
            \par
        
      Modifiez votre module qui calcule le pas du z\'ebu en lui passant un param\`etre suppl\'ementaire : 
