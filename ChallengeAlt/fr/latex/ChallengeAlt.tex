...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
        ...
        \end{sideways}}
            \begin{abstract}
			Avez-vous compris les alternatives ? Voyons \c ca en relevant le d\'efi suivant :
      ...
      cat\'egorie. On peut supposer que l'ann\'ee entr\'ee est correcte.
        ...
        Aides en Java :pour prendre la partie enti\`ere d'un r\'eel en Java, on peut \'ecrire : entier = (int) r\'eel;
