...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
      ...
      \'Ecrivez un algorithme qui affiche le texte :
      ...
      Modifiez votre algorithme pour qu'il lise le temps mis pour parcourir 100m (un r\'eel repr\'esentant le nombre de secondes)
      ...
      Modifiez votre algorithme pour qu'il lise l'ann\'ee de naissance de l'athl\`ete et affiche sa
      cat\'egorie. On peut supposer que l'ann\'ee entr\'ee est correcte.
    
            \par
        Programmez maintenant votre algorithme en Java.
            \par
