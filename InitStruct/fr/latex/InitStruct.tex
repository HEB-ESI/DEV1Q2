...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
                ...
                pdfauthor={}, pdftitle={TD Variables structurées}, pdfkeywords={TD Variables structur\'ees, },pdfpagemode=UseOutlines,pdfpagetransition=Dissolve,nesting=true,
				...
				\title{TD Variables structur\'ees}	
			\date{}
			\author{\scriptsize{}}
			...
			\footnotesize{1\`ere ann\'ee}}
				...
				%\maketitle
				\cadretitre{TD1}{TD Variables structur\'ees}
				\thispagestyle{fancy}
        ...
        \end{sideways}}
            \begin{abstract}
			Ces exercices ont pour but de v\'erifier que vous avez fix\'e les variables structur\'ees.
      ...
      D\'efinir un type Rectangle pouvant d\'ecrire de fa\c con commode un rectangle dans un espace
      \`a deux dimensions et dont les c\^ot\'es sont parall\`eles aux axes des coordonn\'ees. \'Ecrire ensuite
      
					\begin{itemize}
				
			\item un module calculant le p\'erim\`etre d'un rectangle re\c cu en param\`etre ;
			\item un module calculant la surface d'un rectangle re\c cu en param\`etre ;
			\item un module recevant en param\`etre un rectangle R et les coordonn\'ees d'un point P, et
          renvoyant vrai si et seulement si le point P est \`a l'int\'erieur du rectangle R ;
			\item un module recevant en param\`etre un rectangle R et les coordonn\'ees d'un point P, et
          renvoyant vrai si et seulement si le point P est sur le bord du rectangle R ;
			\item un module recevant en param\`etre deux rectangles et renvoyant la valeur bool\'eenne
          vrai si et seulement si ces deux rectangles ont une intersection.
					\end{itemize}
				
            \par
        Pour plus d'exercices, 
      r\'evisez ici (\url{www.heb.be/esi/InitStruct/fr/../../TDStruct/fr/html/unit\_Exercices.html})
            \par
        \end{abstract}
