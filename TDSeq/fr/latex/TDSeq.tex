...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
		...
		\subparagraph{Le type des donn\'ees} 
                ...
                \textcolor{white}{.} \par
								...
								Quel(s) type(s) de donn\'ees utiliseriez-vous et quel nombre de variables avez-vous besoin pour repr\'esenter :
							
					\begin{itemize}
				
			\item un prix hors tva ? \textcolor{gray}{\underline{\hspace*{5em}}} 
			\item votre nom de famille (en supposant que vous n'ayez pas un nom compos\'e) ?  \textcolor{gray}{\underline{\hspace*{10em}}} 
			\item vos initiales ? \textcolor{gray}{\underline{\hspace*{10em}}} 
			\item la longueur d'un rectangle ?  \textcolor{gray}{\underline{\hspace*{5em}}} 
			\item une date du calendrier (au format 8/2/2017 par exemple) ?  \textcolor{gray}{\underline{\hspace*{10em}}} 
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cath/Documents/Cours/DEV1Q2/TDSeq/fr/image/primitifs.png}
						\end{center}
        ...
        \,\verb|num1, num2 : entiers|\,
          ...
          La d\'eclaration des informations apparaitra toujours en \textbf{d\'ebut} d'algorithme.
		...
		\subparagraph{Comment nommer correctement une variable ?} 
          ...
          Voici quelques r\`egles et limitations traditionnelles dans les langages de programmation :
			...
			\item 
            Pour donner un nom compos\'e \`a une variable, on utilise 
            la notation \guillemotleft  chameau \guillemotright  (camelCase en anglais), qui consiste \`a mettre une majuscule
            au d\'ebut des mots (g\'en\'eralement \`a partir du deuxi\`eme), par exemple premierNombre
            ou dateNaissance.
            
			\item 
            Pour donner un nom compos\'e \`a une constante, on utilise le \guillemotleft  tiret bas \guillemotright  ou underscore 
            (par ex. TAUX\_TVA) 
            
			\item 
            On d\'econseille d'utiliser le signe \guillemotleft  - \guillemotright  qui est
...
\end{Java}
        ...
        \subsection{Les op\'erateurs DIV et MOD en algo}
          Ce sont deux op\'erateurs qui ne peuvent s'utiliser qu'avec des variables enti\`eres :
        ...
        \subsection{Les op\'erateurs de comparaison en algo}
          Ce sont des op\'erateurs qui ne peuvent s'utiliser qu'avec des expressions num\'eriques ou des chaines :
        ...
        \subsection{Les op\'erateurs de comparaison en Java}
          Ce sont des op\'erateurs qui ne peuvent s'utiliser qu'avec des expressions num\'eriques :
        ...
        \textbf{L'\'evaluation court-circuit\'ee} :
          ...
          Dans le cas du \verb@ET@, si \verb@cond1@ s'av\`ere faux, 
          il est inutile d'\'evaluer \verb@cond2@ puisque le r\'esultat sera faux de toute fa\c con ;
          l'\'evaluation de \verb@cond2@ 
          et de l'ensemble de la conjonction ne se fera que si \verb@cond1@ est vrai.
          
            \par
        
          De m\^eme, dans le cas du \verb@OU@, si \verb@cond1@ s'av\`ere vrai, 
          il est inutile d'\'evaluer \verb@cond2@ puisque le
          r\'esultat sera vrai de toute fa\c con ; l'\'evaluation de \verb@cond2@ et de l'ensemble de la disjonction
          ne se fera que si \verb@cond1@ est faux.
          ...
          \verb@cond1 ET cond2@ n'est pas la m\^eme que \verb@cond2 ET cond1@, 
        ...
        \subsection{Les op\'erateurs bool\'eens en Java}
          ...
          Java utilise l'\'evaluation court-circuit\'ee.
		...
		\subparagraph{Que vaut ?} 
			...
			\item 7<8 ?  \textcolor{gray}{\underline{\hspace*{3em}}} 
			\item 0<=0 ?  \textcolor{gray}{\underline{\hspace*{3em}}} 
			\item -1<=4 \&\& 4>8 ?  \textcolor{gray}{\underline{\hspace*{3em}}} 
			\item -1>=4 || 4<8 ?  \textcolor{gray}{\underline{\hspace*{3em}}} 
					\end{itemize}
		...
		\subparagraph{} 
            ...
            \item[ \ding{"6F} ] delta = Math.pow(b,2) - 4*a*c;
...
int nombre1 = clavier.nextInt();
 ...
 System.out.println("La variable var vaut " + var);
		...
		\subparagraph{Que vaut ?} 
			...
			\item Quelle est l'instruction qui r\'ealise l'affectation externe de la variable capital ? \textcolor{gray}{\underline{\hspace*{16em}}} 
			\item Quelle est l'instruction qui permet d'afficher le contenu de la variable salaire ? \textcolor{gray}{\underline{\hspace*{16em}}} 
		...
		\subparagraph{Que vaut ?} 
			...
			\item Quel est le contenu de la variable enti\`ere n \`a l'issue de ces 3 lignes de code?\par
                    ...
                    n ← n \% 3 ? \par
				 \textcolor{gray}{\underline{\hspace*{1em}}} 
			\item Quelle est la ligne de code qui d\'eclare et cr\'ee la variable clavier permettant l'acc\`es au clavier en entr\'ee ?  \textcolor{gray}{\underline{\hspace*{20em}}} 
			\item Quelle est la ligne de code qui r\'ealise l'affectation externe de la variable r\'eelle capital ?  \textcolor{gray}{\underline{\hspace*{16em}}} 
			\item Quelle est la ligne de code qui permet d'aller \`a la ligne ?  \textcolor{gray}{\underline{\hspace*{16em}}} 
			\item Quelle est la ligne de code qui permet d'afficher le contenu de la variable salaire et d'aller \`a la ligne ?  \textcolor{gray}{\underline{\hspace*{16em}}} 
        ...
        Nous prendrons l'habitude de commenter chaque algorithme en pr\'ecisant ce qu'il fait.
            ...
            \par
        \subsection{Documenter son code Java}
      Dans un premier temps, vous pourrez documenter votre code \`a l'aide de commentaires.
      
            \par
        Il existe plusieurs mani\`eres d'ajouter un commentaire
            \par
        \begin{Java}
...
\end{Java}
      ...
      Nous en reparlerons plus loin.
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cath/Documents/Cours/DEV1Q2/TDSeq/fr/image/methode.png}
						\end{center}
...
fin algorithme
          ...
          Remarques :
			...
			\item Comme pour les variables, le \textbf{nomAlgorithme} 
            ...
            ne devront pas communiquer un r\'esultat...
...
public class NomClasse {
    ...
    public static double sommerNombres(double nb1, double nb2)
        ...
        \subsection{Java est un langage compil\'e puis interpr\'et\'e}\begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cath/Documents/Cours/DEV1Q2/TDSeq/fr/image/java-jvm-jvm.png}
						\end{center}
...
public class Exercice7 {
    public static void main(String [] args) {
        ...
        \end{Java} \textcolor{gray}{\underline{\hspace*{1em}}} 
					\end{itemize}
				\subsection{Compr\'ehension de codes Java (suite)}
  ...
  Could not find the main class: ErrExecution.java. Program will exit.	\end{verbatim}
            ...
            \item[ \ding{"6D} ] on ex\'ecute le mauvais fichier
		...
		\subparagraph{Consignes} 
          ...
          Voici quelques conseils pour vous guider dans la r\'esolution de tels probl\`emes :
			...
			\item d\'eclarez ensuite les variables (et leur type) qui interviennent dans l'algorithme ; les noms des variables doivent \^etre suffisamment explicites.
...
fin algorithme
          \end{verbatim}
          Traduisons cet algorithme en java en ajoutant le traitement des donn\'ees en entr\'ee et sortie (demande au clavier et affichage \`a l'\'ecran) :
          \begin{Java}
import java.util.Scanner;
public class Triangle{
    ...
    public static double troisiemeAngleTriangle(double angle1, double angle2) {
        ...
        \'Ecrivez les algorithmes et codez les programmes Java correspondant qui 
			...
			\item dans 3 algorithmes/m\'ethodes diff\'erent(e)s affiche respectivement  "*", "**", "***" .
        ...
        ***
			...
			\item calcule et retourne la surface d'un carr\'e en recevant la valeur de son c\^ot\'e. Pour rappel, la surface du carr\'e est la longueur du c\^ot\'e au carr\'e.
			\item calcule et retourne la surface d'un rectangle en recevant les valeurs de sa longueur et sa largeur . Pour rappel, la surface du rectangle est la longueur multipli\'ee par la largeur.
			\item calcule et retourne la surface d'un cercle en recevant la valeur de son rayon. Pour rappel, la surface du cercle est PI multipli\'e par la valeur du rayon au carr\'e. (Pensez \`a aller voir la classe Math pour obtenir la valeur de PI ;))
            ...
            Pour rappel, le prix total est la quantit\'e multipli\'ee par le prix unitaire multipli\'e par (1 + le taux de tva)
