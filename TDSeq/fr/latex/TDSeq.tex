...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cuvelier/Documents/ESI/Java/2016-2017/DEV1Q2/notes/DEV1Q2/TDSeq/fr/image/primitifs.png}
						\end{center}
...
\end{Java}\section{Structure g\'en\'erale}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cuvelier/Documents/ESI/Java/2016-2017/DEV1Q2/notes/DEV1Q2/TDSeq/fr/image/methode.png}
						\end{center}
...
public class NomClasse {
    public static void main(String [] args) {
        ...
        \subsection{Java est un langage compil\'e puis interpr\'et\'e}\begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cuvelier/Documents/ESI/Java/2016-2017/DEV1Q2/notes/DEV1Q2/TDSeq/fr/image/java-jvm-jvm.png}
						\end{center}
