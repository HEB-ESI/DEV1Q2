...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
        ...
        \end{sideways}}
            \begin{abstract}
			Ce premier TD 
			a pour but de vous rappeler les commandes 
			\verb@Linux@,
        ...
        \subsection{Le syst\`eme de fichiers}\begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/arborescenceUnix.png}
						\end{center}
		...
		\subparagraph{La ligne de commande} 
			...
			\item 
				...
				\begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/fs.jpeg}
						\end{center}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/groupesLinux1.jpg}
						\end{center}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/permissions.jpg}
						\end{center}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/permissions2.jpg}
						\end{center}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/ls-l.jpg}
						\end{center}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/ls-l-permissions.jpg}
						\end{center}
...
\end{Java}
	...
	who | cut -f 1 -d ' ' | sort | uniq | wc -l
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=1\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1EnQ2/TDLinux/fr/image/capt1.png}
						\end{center}
