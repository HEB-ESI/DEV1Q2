...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
                ...
                pdfauthor={}, pdftitle={Challenge : les chaines}, pdfkeywords={Challenge : les chaines, },pdfpagemode=UseOutlines,pdfpagetransition=Dissolve,nesting=true,
			...
			\footnotesize{1\`ere ann\'ee}}
				...
				%\maketitle
				\cadretitre{TD1}{Challenge : les chaines}
				\thispagestyle{fancy}
        ...
        \end{sideways}}
            \begin{abstract}
			R\'esolvons cette fois encore un examen
    
            \par
        
      Vous trouverez par exemple Le Scrabble ici (\url{www.heb.be/esi/ChallengeChaine/fr/../../ChallengeChaine/fr/examen/DEV1-e-janvier-150123-SRV.pdf}).
