...
fin algorithme
      \end{verbatim}\subsection{D\'eclaration et cr\'eation en Java}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cuvelier/Documents/ESI/Java/2016-2017/DEV1Q2/notes/DEV1Q2/TDTableau/fr/image/tabPres.png}
						\end{center}
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cuvelier/Documents/ESI/Java/2016-2017/DEV1Q2/notes/DEV1Q2/TDTableau/fr/image/reference.png}
						\end{center}
...
4   −1, −3, −4      −1        que des négatifs
        ...
        \begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cuvelier/Documents/ESI/Java/2016-2017/DEV1Q2/notes/DEV1Q2/TDTableau/fr/image/junit.jpeg}
						\end{center}
	...
	alias javatest='java org.junit.runner.JUnitCore'
		...
		\subparagraph{S\'election multiple} 
                ...
                \textcolor{white}{.} \par
							...
							\begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.5\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/cuvelier/Documents/ESI/Java/2016-2017/DEV1Q2/notes/DEV1Q2/TDTableau/fr/image/tab3.jpg}
						\end{center}
