		...
		\subparagraph{sinus} 
          ...
          Dans un triangle rectangle,
			...
			\item le sinus \^A est donn\'e par le c\^ot\'e oppos\'e (o) divis\'e par l'hypot\'enuse (h).
				...
				\begin{figure}[hbt]
				    \begin{center}
					\includegraphics[width=0.8\linewidth,height=0.8\textheight,keepaspectratio=true]{/home/clr/Documents/Cours/DEV1Q2/TDModule/fr/image/sin.png}
						\end{center}
