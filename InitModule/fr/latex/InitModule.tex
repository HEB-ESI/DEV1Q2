...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
                ...
                pdfauthor={}, pdftitle={TD Gestion d'erreur et Javadoc}, pdfkeywords={TD Gestion d'erreur et Javadoc, },pdfpagemode=UseOutlines,pdfpagetransition=Dissolve,nesting=true,
				...
				\title{TD Gestion d'erreur et Javadoc}	
			\date{}
			\author{\scriptsize{}}
			...
			\footnotesize{1\`ere ann\'ee}}
				...
				%\maketitle
				\cadretitre{TD1}{TD Gestion d'erreur et Javadoc}
				\thispagestyle{fancy}
