...
\lstnewenvironment{Java}[1][]{\lstset{style=lstverb,language=java,#1}}{}
                ...
                pdfauthor={}, pdftitle={Les packages}, pdfkeywords={Les packages, },pdfpagemode=UseOutlines,pdfpagetransition=Dissolve,nesting=true,
        ...
        \end{sideways}}
            \begin{abstract}
			Ces exercices ont pour but de v\'erifier que vous avez fix\'e comment associer un package \`a vos m\'ethodes.
      ...
      Voici quelques conseils pour vous guider dans la r\'esolution de tels probl\`emes :
        ...
        Vous trouverez cet \'enonc\'e ici (\url{www.heb.be/esi/InitPackage/fr/../../InitPackage/fr/enonce/DEV1-LAJ-i3-20151112-clr.pdf}).
